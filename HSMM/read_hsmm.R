...
write_json(pts_leader, "../back-end/hsmm-pts.json")
write_json(ast_leader, "../back-end/hsmm-ast.json")
write_json(reb_leader, "../back-end/hsmm-reb.json")
write_json(blk_leader, "../back-end/hsmm-blk.json")
write_json(stl_leader, "../back-end/hsmm-stl.json")
write_json(mp_leader, "../back-end/hsmm-mp.json")
write_json(`3p%_leader`, "../back-end/hsmm-pth.json")
write_json(`fg%_leader`, "../back-end/hsmm-fg.json")
write_json(`ft%_leader`, "../back-end/hsmm-ft.json")
write_json(player, "../back-end/hsmm-players.json")
write_json(dates, "../back-end/hsmm-game_dates.json")
write_json(master, "../back-end/hsmm-master.json")
write_json(teams, "../back-end/hsmm-teams.json")
write_json(team_stats, "../back-end/hsmm-team_stats.json")
